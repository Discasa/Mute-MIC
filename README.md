...
<p align="center">
  <img src="src/MuteMIC.App/Assets/Icons/app.ico" alt="Mute MIC icon" width="96" height="96">
</p>

<p align="center">
  <strong>Mute every microphone and audio input on Windows with one click.</strong>
</p>
...
Mute MIC is a lightweight Windows tray app made for people who use more than
one input device, such as a USB audio interface, a headset mic, and virtual
microphones.

Instead of selecting one microphone, Mute MIC controls every active audio input
at the same time.
...
Mute MIC is a modernized app based on the original
[Anc813/MicMute](https://github.com/Anc813/MicMute) project.
